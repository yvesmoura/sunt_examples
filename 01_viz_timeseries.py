...
# ---------------------------------------------------------------------------
# Figure D – Raw signal + rolling 7-day trend for a single stop
# ---------------------------------------------------------------------------
s = ts[SINGLE_STOP]
roll = s.rolling(window=24 * 7, center=True, min_periods=1).mean()
...
ax.legend()
fig.tight_layout()
fig.savefig(OUTPUT_DIR / "D_trend_decomposition.png", dpi=150)
plt.close(fig)
print("Saved D_trend_decomposition.png")
